...
export const Header = () => {
  ...
  return (
    <header className="flex flex-col sm:flex-row sm:justify-betweenw-full max-w-5xl mb-6 gap-6 pt-4 pb-8 px-2">
      <Link href="/" className="flex flex-col">
        <h1 className="font-inter font-bold sm:text-xl tracking-tight flex items-center text-white">
          <img
      ...
      <div className="flex items-center gap-3 pt-4">
        <a
          ...
          href="https://github.com/whoiskatrin/figma-to-tailwindcss"
